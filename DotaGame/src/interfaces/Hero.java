...
public interface Hero {
    ...
    Collection<entities.Items.Item> getItems();

    void addItem(Item item) throws NoSuchFieldException, IllegalAccessException;

    void addRecipe(Recipe recipe) throws NoSuchFieldException, IllegalAccessException;

    void attackHero(Heroes.Hero hero);
}