...
public interface Inventory {
    ...
    void addCommonItem(Item item) throws NoSuchFieldException, IllegalAccessException;

    void addRecipeItem(Recipe recipe) throws NoSuchFieldException, IllegalAccessException;
}